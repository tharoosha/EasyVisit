...
<x-authentication-card>
    ...
    <!-- <x-slot name="logo">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="telephoneNumber" value="{{ __('Phone Number') }}" />
                <x-input id="telephoneNumber" class="block mt-1 w-full" type="text" name="telephoneNumber" :value="old('telephoneNumber')" required autofocus autocomplete="telephoneNumber" />
            </div>
            <div>
